"""
file: pyqmh_sequence_editor/app.py
description: pyqmh Sequence Editor for creating, editing and managing pyqmh sequence files
author: Larry
"""
...
from module import PyqmhSequenceEditor
...
class App():
    def __init__(self, debug: bool = False):
        ...
        self._web_gui = ModuleWebGui(
            logger=self.logger,
            module_folder_name="pyqmh_sequence_editor",
        )
