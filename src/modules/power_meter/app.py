...
if __package__ in (None, ""):
    # Support running this file directly: python src/modules/power_meter/app.py
    src_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
    if src_root not in sys.path:
        sys.path.insert(0, src_root)
    from modules.power_meter.factory import PowerMeter
    from modules.power_meter.www import ModuleWebGui
else:
...
class App():
    def __init__(self, debug: bool = False):
        ...
        self._web_gui = ModuleWebGui(
            ...
            module_folder_name="power_meter",
        )
